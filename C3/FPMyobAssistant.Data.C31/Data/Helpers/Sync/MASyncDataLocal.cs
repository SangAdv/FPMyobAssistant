...
namespace FPMyobAssistant
{
    internal class MASyncDataLocal : ASASyncFW
    {
        ...
        public override async ValueTask DoSyncAsync(List<SASyncDataItem> updateItems)
        {
        ...
        public override async ValueTask RemoveItemAsync(string mainType, string subType = "")
        {
