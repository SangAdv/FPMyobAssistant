...
namespace FPMyobAssistant
{
    internal sealed partial class MALocalAccess
    {
        ...
        internal void TLDBSUpdate(TLDB data)
        {
        ...
        internal void TLDBSBudgetUpdate(TLDBSBudget data)
        {
        ...
        internal void TLDPLUpdate(TLDPL data)
        {
            if (data.Actual == 0) return;
            data.AccountId = data.AccountId.Trim().AddLeadingZeros(10);
            using (var db = new LocalModelDataContext(mServer.Database.ConnectionString))
        ...
        internal void TLDPLBudgetUpdate(TLDPLBudget data)
        {
            if (data.Budget == 0) return;
            using (var db = new LocalModelDataContext(mServer.Database.ConnectionString))
            {
        ...
        internal void TLDDHLCustomerNumberUpdate(TLDDHLCustomerNumber data)
        {
            using (var db = new LocalModelDataContext(mServer.Database.ConnectionString))
            {
        ...
        internal void TLMBSAccountUpdate(TLMBSAccount data)
        {
            using (var db = new LocalModelDataContext(mServer.Database.ConnectionString))
            {
        ...
        internal void TLMPLAccountUpdate(TLMPLAccount data)
        {
            using (var db = new LocalModelDataContext(mServer.Database.ConnectionString))
            {
        ...
        internal void TLMReportStructureUpdate(List<TLMReportStructure> data)
        {
            using (var db = new LocalModelDataContext(mServer.Database.ConnectionString))
            {
                foreach (var item in data)
        ...
        internal void TLMReportUpdate(TLMReport data)
        {
            using (var db = new LocalModelDataContext(mServer.Database.ConnectionString))
            {
        ...
        internal void TLSSettingUpdate(TLSSetting data)
        {
            data.Id = 1;
            using (var db = new LocalModelDataContext(mServer.Database.ConnectionString))
            {
