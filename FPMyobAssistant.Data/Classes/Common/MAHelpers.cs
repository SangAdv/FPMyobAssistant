...
{
    public class MAHelpers
    {
        #region Methods

        public Dictionary<string, string> FinancialPeriods { get; } = new Dictionary<string, string>();

        #endregion Methods

        #region Constructor

        public MAHelpers(bool isBudget = false)
        {
        ...
        public static MABSStorageItem FromPLStorageItem(MAPLStorageItem storageItem)
        {
        ...
        public static string SetMAId(int reportId, int headingId, int itemId)
        {
            return $"({reportId})[{headingId}]<{itemId}>";
        }

        public static (int reportId, int headingId, int itemId) GetMAId(string maId)
        {
        ...
        public static List<string> GetAllAccountCodes(MAReportStructureItem structItem)
        {
