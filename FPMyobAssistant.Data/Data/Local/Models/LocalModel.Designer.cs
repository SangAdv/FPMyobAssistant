...
// Code is generated on: 8/04/2019 8:40:53 AM
//
...
namespace LocalModelContext
{
    ...
    public partial class TLDRepto : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_CardId", CanBeNull = false, DbType = "NVARCHAR NOT NULL", IsPrimaryKey = true)]
        ...
        /// </summary>
        [Column(Storage = "_Value", CanBeNull = false, DbType = "FLOAT NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public double Value
        {
            get
            {
    ...
    public partial class TLMDistributor : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_DistributorId", AutoSync = AutoSync.OnInsert, CanBeNull = false, DbType = "INTEGER NOT NULL", IsDbGenerated = true, IsPrimaryKey = true)]
